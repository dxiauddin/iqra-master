  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl mx-auto w-full pt-2 pb-2 text-center relative z-10 space-y-2">
        ...
        <p className="text-[15px] text-zinc-300">Sila log masuk untuk menyimpan rekod pencapaian anda.</p>
      </div>
        ...
        <div className="relative w-full">
          ...
          <div className="relative p-[1.5px] rounded-3xl overflow-hidden w-full shadow-[0_15px_35px_rgba(0,0,0,0.8)]">
            ...
            <div className="relative w-full bg-zinc-950/95 backdrop-blur-3xl text-white rounded-[22px] pt-6 pb-8 px-6 flex flex-col items-center gap-6 border border-white/10">
              ...
              {showEmailModal && (
                <form onSubmit={handleEmailLogin} className="flex flex-col gap-4 w-full bg-zinc-900/80 p-4.5 rounded-2xl border border-white/10 animate-fadeIn">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <div className="flex justify-between items-center">
                      ...
                      <Link href="/forgot-password" className="text-[14px] text-emerald-400 hover:underline">
                        Lupa kata laluan?
                      </Link>
                    </div>
